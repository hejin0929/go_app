...
//// @Summary 用户登录操作
//// @ID SignUser
//// @Param body body	UserSignType true "JSON数据"
...
//
//	if errDb != nil {
//		writeLog.Println(errDb)
//	}
//
//	testName := UserName{}
//
//	selectNameTemplate := fmt.Sprintf(`SELECT phone FROM Users WHERE phone = '%s'`, newUser.Phone)
//
//	err = db.Model(selectNameTemplate).Scan(&testName.Phone).Error
//
//	if err != nil {
//		writeLog.Println(err)
//	}
...
//	//db.
//
//	id, err := sql.InsertOneData("insert into users(phone, password, uid) value(?, ?, ?)", writeLog, newUser.Phone, newUser.Password, uid)
//
//	if err != nil {
//		fmt.Println(err)
...
//	resp.Body.Uid = strconv.Itoa(int(id))
//
//	r.JSON(200, resp)
//}
//
